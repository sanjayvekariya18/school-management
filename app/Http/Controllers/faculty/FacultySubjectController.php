...
use App\Faculty\Faculty_subject;
...
class FacultySubjectController extends Controller
{
    ...
    public function index()
    {
        ...
        // die;
        return view('faculty.faculty_subject.index',compact('faculty_subjects'));
    }
    ...
    public function create()
    {
        ...
        return view('faculty.faculty_subject.create',compact('faculties','streams','semesters','divisons','subjects'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('faculty/faculty_subject');
    }
    ...
    public function edit($id)
    {
        ...
        // die;
        return view('faculty.faculty_subject.edit',compact('faculty_subject','faculties','streams','semesters','divisons','subjects'));
    }
