...
class ParaListController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('faculty.para_list.index',compact('para_lists'));
    }
    ...
    public function create()
    {
        ...
        return view('faculty.para_list.create',compact('subjects'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $para_list->save();
        return redirect('faculty/para_list');
    ...
    public function edit($id)
    {
        ...
        // die;
        return view('faculty.para_list.edit',compact('para_list','subjects'));
    }
