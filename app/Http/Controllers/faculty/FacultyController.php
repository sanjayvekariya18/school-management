...
class FacultyController extends Controller
{
    ...
    public function index()
    {
        ...
        // die;
        return view('faculty.faculty.index',compact('faculties'));
    }
    ...
    {
        $streams = Stream::all();
        return view('faculty.faculty.create',compact('streams'));
    }
    ...
    public function store(Request $request)
    {
        ...
        try{
            ...
            echo $ex->getMessage();
            return redirect('faculty/faculty')->with("msg" ,$ex->getMessage());
        }
        
        return redirect('faculty/faculty')->with("msg","Faculty Added");
    ...
    public function edit($id)
    {
        ...
        // print_r($faculty->toarray());
        // die;
        return view('faculty.faculty.edit',compact('faculty','streams'));
    }
