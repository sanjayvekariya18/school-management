...
class McqQuestionController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('faculty.mcq_question.index',compact('mcq_questions'));
    }
    ...
    public function create()
    {
        ...
        return view('faculty.mcq_question.create',compact('subjects'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('faculty/mcq_question');
    }
    ...
    public function edit($id)
    {
        ...
        // die;
        return view('faculty.mcq_question.edit',compact('mcq_question','subjects'));
    }
