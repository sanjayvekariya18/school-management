...
class EnrollStudentController extends Controller
{
    ...
    public function index()
    {
        ...
        // die;
        return view('admin.enroll_student.index',compact('enroll_students'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.enroll_student.create',compact('students','streams','semesters','divisons'));
    }
    ...
    public function store(Request $request)
    {
        ...
        // die;
        $enroll_student->save();
        return redirect('admin/enroll_student');
    }
    ...
    public function edit($id)
    {
        ...
        // die;
        return view('admin.enroll_student.edit',compact('enroll_student','streams','semesters','divisons'));
    }
