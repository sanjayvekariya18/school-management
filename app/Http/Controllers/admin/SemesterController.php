...
class SemesterController extends Controller
{
    ...
    {
        $streams = Stream::all();
        return view('admin.semester.create',compact('streams'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $request->validate([
            ...
            "sem_name.numeric" => "Semester Number Must Be Numeric"
        ]);
    ...
    public function edit($id)
    {
        ...
        // die;
        return view('admin.semester.edit',compact('semester','streams'));
    }
