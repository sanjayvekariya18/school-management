                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="table-responsive table-body">
                                    <!--buttons_start-->
                                    <div class="col-md-12">
                                        <a href="{{url('admin/faculty_subject/create')}}" class="btn btn-info "><i class="fa fa-align-center"></i>&nbsp;&nbsp;Add Faculty Subject</a>
                                    ...
                                    <table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                        ...
                                        @foreach($faculty_subjects as $faculty_subject)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{url('admin/faculty_subject/'.$faculty_subject->id.'/edit')}}" class="btn btn-circle btn-lg btn-success icon-size">
                                                         <i class="fa fa-pencil-square-o"></i>
                                                    </a>
                                                    <span>
                                                    <form class="deleteForm" style="display:inline-block;" action="{{url('admin/faculty_subject/'.$faculty_subject->id)}}" method="post">
                                                    @csrf
                                                    @method('delete')
    ...
    $(document).ready(function(){
        ...
        function action(action){
            ...
            $.ajax({
                ...
                url: '{{url("admin/faculty_subject/action")}}',
