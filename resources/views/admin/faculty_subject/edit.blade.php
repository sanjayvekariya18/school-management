                        ...
                        <div class="card card-body">
                            ...
                            <div class="row">
                                <div class="col-sm-12 col-xs-12">
                                    <form  method="post" action="{{url('admin/faculty_subject/'.$faculty_subject->id)}}" enctype="multipart/form-data">
                                    @method('put')
                                    @csrf
                                    <div class="form-group">
                                        <div class="form-group">
                                            <div class="txt_border">
                                                ...
                                                <select class="form-control" name="faculty_id" id="name">
                                                    ...
                                                    @if($faculty->id == $faculty_subject->faculty_id)
                                        ...
                                        <div class="form-group">
                                            <div class="txt_border">
                                                ...
                                                <select class="form-control" name="stream_id" id="name">
                                                    ...
                                                    @if($stream->id == $faculty_subject->stream_id)
                                        ...
                                        <div class="form-group">
                                            <div class="txt_border">
                                                ...
                                                <select class="form-control" name="semester_id" id="name">
                                                    ...
                                                    @if($semester->id == $faculty_subject->semester_id)
                                        ...
                                        <div class="form-group">
                                            <div class="txt_border">
                                                ...
                                                <select class="form-control" name="divison_id" id="name">
                                                    ...
                                                    @if($divison->id == $faculty_subject->divison_id)
                                        ...
                                        <div class="form-group">
                                            <div class="txt_border">
                                                ...
                                                <select class="form-control" name="subject_id" id="name">
                                                    ...
                                                    @if($subject->id == $faculty_subject->subject_id)
                                        ...
                                        <a href="{{url('admin/faculty_subject')}}" type="submit" class="btn btn-danger border-danger">Cancel</a>
                                    </form>
                                </div>
                            </div>
                        </div>
