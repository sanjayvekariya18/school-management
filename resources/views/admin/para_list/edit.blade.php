                        ...
                        <div class="card card-body">
                            ...
                            <div class="row">
                                <div class="col-sm-12 col-xs-12">
                                    <form  method="post" action="{{url('admin/para_list/'.$para_list->id)}}">
                                    @method('put')
                                    @csrf
                                        ...
                                        <div class="txt_border">
                                            ...
                                            <select class="form-control" name="subject_id" id="subject_id">
                                                ...
                                                @foreach($subjects as $subject)
                                                    @if($subject->id == $para_list->subject_id)
                                    ...
                                    <div class="form-group {{($errors->has('para_name')) ? 'has-danger' : ''}}">
                                        <label for="para_name" >Question:</label>
                                        <input type="text" name="para_name" value="{{$para_list->para_name}}" id="para_name" class="form-control txt_border" placeholder="Enter Question">
                                        <span class="text-danger">{{$errors->first('para_name')}}</span>
                                    </div>
                                    <div class="form-group {{($errors->has('para_description')) ? 'has-danger' : ''}}">
                                        <label for="para_description" >Question:</label>
                                        <input type="text" name="para_description" value="{{$para_list->para_description}}" id="para_description" class="form-control txt_border" placeholder="Enter Description">
                                    ...
                                    <div class="form-group {{($errors->has('correct_ans')) ? 'has-danger' : ''}}">
                                        ...
                                        <input type="text" name="correct_ans" value="{{$para_list->correct_ans}}" id="correct_ans" class="form-control txt_border" placeholder="Enter Correct Answer">
                                        <span class="text-danger">{{$errors->first('correct_ans')}}</span> 
                                    </div>

                                    <div class="form-group {{($errors->has('mark')) ? 'has-danger' : ''}}">
                                        <label for="mark" >Mark:</label>
                                        <input type="text" name="mark" id="mark" value="{{$para_list->mark}}" class="form-control txt_border" placeholder="Enter Mark ">
                                    ...
                                    <div class="form-group {{($errors->has('negative_mark')) ? 'has-danger' : ''}}">
                                        ...
                                        <input type="text" name="negative_mark" id="negative_mark" value="{{$para_list->negative_mark}}" class="form-control txt_border" placeholder="Enter Nagative Mark">
