                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="table-responsive table-body">
                                    <!--buttons_start-->
                                    <div class="col-md-12">
                                        <a href="{{url('admin/subject/create')}}" class="btn btn-info "><i class="fa fa-align-center"></i>&nbsp;&nbsp;Add Subject</a>
                                    ...
                                    <table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                        ...
                                        @foreach($subjects as $subject)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{url('admin/subject/'.$subject->id.'/edit')}}" class="btn btn-circle btn-lg btn-success icon-size">
                                                         <i class="fa fa-pencil-square-o"></i>
                                                    </a>
                                                    <span>
                                                    <form class="deleteForm" style="display:inline-block;" action="{{url('admin/subject/'.$subject->id)}}" method="post">
                                                    @csrf
                                                    @method('delete')
