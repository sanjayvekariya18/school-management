                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                 <!--buttons_start-->
                                    <div>
                                        <a href="{{url('admin/stream/create')}}" class="btn btn-info"><i class="fa fa-align-center"></i>&nbsp;&nbsp;Add Stream</a>
                                    ...
                                    <table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                        ...
                                        @foreach($streams as $stream)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{url('admin/stream/'.$stream->id.'/edit')}}" class="btn btn-circle btn-lg btn-success icon-size">
                                                         <i class="fa fa-pencil-square-o"></i>
                                                    </a>
                                                    <span>
                                                    <form class="deleteForm" style="display:inline-block;" action="{{url('admin/stream/'.$stream->id)}}" method="post">
                                                    @csrf
                                                    @method('delete')
