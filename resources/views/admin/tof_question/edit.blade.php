                        ...
                        <div class="card card-body">
                            ...
                            <div class="row">
                                <div class="col-sm-12 col-xs-12">
                                    <form  method="post" action="{{url('admin/tof_question/'.$tof_question->id)}}">
                                    @method('put')
                                    @csrf
                                        ...
                                        <div class="txt_border">
                                            ...
                                            <select class="form-control" name="subject_id" id="subject_id">
                                                ...
                                                @foreach($subjects as $subject)
                                                    @if($subject->id == $tof_question->subject_id)
                                    ...
                                    <div class="form-group {{($errors->has('question')) ? 'has-danger' : ''}}">
                                        ...
                                        <input type="text" name="question" value="{{$tof_question->question}}" id="question" class="form-control txt_border" placeholder="Enter Question">
                                    ...
                                    <div class="form-group {{($errors->has('correct_ans')) ? 'has-danger' : ''}}">
                                        ...
                                        <div class="txt_border">
                                            <select class="form-control" name="correct_ans"> 
                                                <option value="">SELECT</option>
                                                <option value="True" {{($tof_question->correct_ans == "True") ? "selected" : "" }}>True</option>
                                                <option value="False" {{($tof_question->correct_ans == "False") ? "selected" : "" }}>False</option>
                                            </select>
                                    ...
                                    <div class="form-group {{($errors->has('mark')) ? 'has-danger' : ''}}">
                                        ...
                                        <input type="text" name="mark" id="mark" value="{{$tof_question->mark}}" class="form-control txt_border" placeholder="Enter Mark ">
                                    ...
                                    <div class="form-group {{($errors->has('negative_mark')) ? 'has-danger' : ''}}">
                                        ...
                                        <input type="text" name="negative_mark" id="negative_mark" value="{{$tof_question->negative_mark}}" class="form-control txt_border" placeholder="Enter Nagative Mark">
