                    ...
                    <div class="col-md-6">
                        <div class="card card-body">
                            ...
                            <div class="row">
                                ...
                                <form  method="post" action="{{url('admin/test_question/'.$test_question->id)}}">
                                    @method('put')
                                    @csrf
                                    <div class="form-group">
                                        <div class="form-group">
                                            <label for="test_id">Select Test Id</label>
                                            <select class="form-control" name="test_id" id="name">
                                                <option value="">SELECT</option>
                                                @foreach($tests as $test)
                                                    @if($test->id == $test_question->test_id)
                                        ...
                                        <input type="text" name="context_id" value="{{$test_question->context_id}}" id="context_id" class="form-control txt_border" placeholder="Enter Context Id  ">
                                        <span class="text-danger">{{$errors->first('context_id')}}</span>
                                        </div> 
                                        <div class="form-group {{($errors->has('question_type')) ? 'has-danger' : ''}}">
                                        <label for="question_type" >Question Type :</label>
                                        <input type="text" name="question_type" value="{{$test_question->question_type}}" id="question_type" class="form-control txt_border" placeholder="Enter Question Type ">
                                        ...
                                        <a href="{{url('admin/test_question')}}" type="submit" class="btn btn-danger border-danger">Cancel</a>
                                    </form>
                                </div>
                            </div>
                        </div>
