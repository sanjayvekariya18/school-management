                        ...
                        <div class="card card-body">
                            ...
                            <div class="row">
                                <div class="col-sm-12 col-xs-12">
                                    <form  method="post" action="{{url('faculty/create_test/'.$create_test->id)}}">
                                    @method('put')
                                    @csrf
                                            ...
                                            <div class="txt_border">
                                                ...
                                                <select class="form-control" name="semester_id" id="semester_id">
                                                    ...
                                                    @foreach($semesters as $semester)
                                                        @if($semester->id == $test->semester_id)
                                    ...
                                    <div class="form-group {{($errors->has('test_name')) ? 'has-danger' : ''}}">
                                        ...
                                        <input type="text" name="test_name" value="{{$create_test->test_name}}" id="test_name" class="form-control txt_border" placeholder="Enter Test Name">
                                        <span class="text-danger">{{$errors->first('test_name')}}</span>
                                    </div>
                                    <div class="form-group {{($errors->has('description')) ? 'has-danger' : ''}}">
                                        <label for="description" >Test Description:</label>
                                        <input type="text" name="description" value="{{$create_test->description}}" id="para_description" class="form-control txt_border" placeholder="Enter Description">
                                        <span class="text-danger">{{$errors->first('description')}}</span>
                                    </div>
                                    <div class="form-group {{($errors->has('no_of_ques')) ? 'has-danger' : ''}}">
                                        <label for="no_of_ques" >No Of Questions:</label>
                                        <input type="text" name="no_of_ques" id="no_of_ques" value="{{$create_test->no_of_ques}}" class="form-control txt_border" placeholder="Enter No Of Question">
                                    ...
                                    <div class="form-group {{($errors->has('total_mark')) ? 'has-danger' : ''}}">
                                        ...
                                        <input type="text" name="total_mark" id="total_mark" value="{{$create_test->total_mark}}" class="form-control txt_border" placeholder="Enter Total Marks">
                                    ...
                                    <div class="form-group {{($errors->has('pass_mark')) ? 'has-danger' : ''}}">
                                        ...
                                        <input type="text" name="pass_mark" id="pass_mark" value="{{$create_test->pass_mark}}" class="form-control txt_border" placeholder="Enter Passing Mark ">
                                    ...
                                    <div class="form-group {{($errors->has('test_duration')) ? 'has-danger' : ''}}">
                                        ...
                                        <input type="text" name="test_duration"  id="test_duration" value="{{$create_test->test_duration}}" class="form-control txt_border" placeholder="Enter Test Duration">
                                        <span class="text-danger">{{$errors->first('test_duration')}}</span>
                                    </div>
                                        <button type="submit" class="btn btn-success waves-effect waves-light m-r-10">Submit</button>
                                        <a href="{{url('faculty/create_test')}}" type="submit" class="btn btn-white text-black border-0">Cancel</a>
                                    </form>
                                </div>
                            </div>
                        </div>
