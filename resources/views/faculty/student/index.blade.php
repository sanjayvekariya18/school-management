                    ...
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h6 class="card-subtitle">Student Details Of Collage</h6>
                                <div class="table-responsive table-body">
                                    <!--buttons_start-->
                                    <div class="col-md-12">
                                        <a href="{{url('faculty/student/create')}}" class="btn btn-info "><i class="fa fa-align-center"></i>&nbsp;&nbsp;Add Student</a>
                                    ...
                                    <table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                        ...
                                        @foreach($students as $student)
                                            <tr>
                                            <td><input type="checkbox" value="{{$student->id}}" name="id[]" class="check"/></td>
                                                <td>{{$student->id}}</td>
                                                <td>{{$student->faculty->fac_name}}</td>
                                                <td><img src="{{asset('storage/'.$student->image)}}" width="100" /></td>
                                                ...
                                                <td>{{$student->email}}</td>
                                                <td>{{($student->status) ? "Active" : "Deactive"}}</td>

                                                <td>
                                                    <a href="{{url('faculty/student/'.$student->id.'/edit')}}" class="btn btn-circle btn-lg btn-success icon-size">
                                                         <i class="fa fa-pencil-square-o"></i>
                                                    </a>
                                                    <span>
                                                    <form class="deleteForm" style="display:inline-block;" action="{{url('faculty/student/'.$student->id)}}" method="post">
                                                    @csrf
                                                    @method('delete')
...
<script>
    ...
    $(document).ready(function(){
        ...
        function action(action){
            ...
            $.ajax({
                type: 'POST',
                data:{ids:students.join(','),action:action},
                url: '{{url("faculty/student/action")}}',
