                        ...
                        <div class="card card-body">
                            ...
                            <div class="row">
                                <div class="col-sm-12 col-xs-12">
                                    <form  method="post" action="{{url('faculty/stream/'.$stream->id)}}">
                                    @method('put')
                                    @csrf
                                    <div class="form-group">
                                        <div class="txt_border">    
                                            ...
                                            <select class="form-control" name="stream_name" id="stream_name" >
                                                ...
                                                <option value="BCA" {{($stream->stream_name == "BCA") ? "selected" : "" }}>BCA</option>
                                                <option value="BBA" {{($stream->stream_name == "BBA") ? "selected" : "" }}>BBA</option>
                                                <option value="B.COM" {{($stream->stream_name == "B.COM") ? "selected" : "" }}>B.COM</option>
                                            </select>
                                        </div>
                                        <!-- <input type="text" name="name" value="{{$stream->name}}"/> -->
                                    </div>
                                        <button type="submit" class="btn btn-success waves-effect waves-light m-r-10">Submit</button>
                                        <a href="{{url('faculty/stream')}}" type="submit" class="btn btn-danger border-danger">Cancel</a>
                                    </form>
                                </div>
                            </div>
                        </div>
