                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <!-- ============================================================== -->
                                <h4 class="card-title">Stream Detail</h4>
                                <h6 class="card-subtitle">Stream Details Of Student</h6>
                               
                                <div class="table-responsive">
                                 <!--buttons_start-->
                                    <div>
                                        <a href="{{url('faculty/stream/create')}}" class="btn btn-info"><i class="fa fa-align-center"></i>&nbsp;&nbsp;Add Stream</a>
                                    ...
                                    <table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                        ...
                                        @foreach($streams as $stream)
                                            <tr>
                                                <td><input type="checkbox" value="{{$stream->id}}" name="id[]" class="check"/></td>
                                                <td>{{$stream->id}}</td>
                                                <td>{{$stream->stream_name}}</td>
                                                <td>
                                                    <a href="{{url('faculty/stream/'.$stream->id.'/edit')}}" class="btn btn-circle btn-lg btn-success icon-size">
                                                         <i class="fa fa-pencil-square-o"></i>
                                                    </a>
                                                    <span>
                                                    <form class="deleteForm" style="display:inline-block;" action="{{url('faculty/stream/'.$stream->id)}}" method="post">
                                                    @csrf
                                                    @method('delete')
...
$(document).on('click','.deleteBtn',function(e){
    ...
    $(document).ready(function(){
        ...
        function action(action){
            ...
            $.ajax({
                type: 'POST',
                data:{ids:streams.join(','),action:action},
                url: '{{url("faculty/stream/action")}}',
