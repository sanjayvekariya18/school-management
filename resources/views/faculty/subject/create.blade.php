                        ...
                        <div class="card card-body">
                            ...
                            <div class="row">
                                <div class="col-sm-12 col-xs-12">
                                    <form  method="post" action="{{url('faculty/subject')}}">
                                    @csrf
                                    ...
                                    <div class="form-group {{($errors->has('sub_name')) ? 'has-danger' : ''}}">
                                        ...
                                        <input type="text" name="sub_name" value="{{old('sub_name')}}" id="sub_name" class="form-control txt_border" placeholder="Enter Subject Name">
                                        <span class="text-danger">{{$errors->first('sub_name')}}</span>
                                    </div>
                                    <div class="form-group {{($errors->has('sub_code')) ? 'has-danger' : ''}}">
                                        <label for="sub_code" >Subject Code:</label>
                                        <input type="text" name="sub_code" id="sub_code" value="{{old('sub_code')}}" class="form-control txt_border" placeholder="Enter Subject Code">
