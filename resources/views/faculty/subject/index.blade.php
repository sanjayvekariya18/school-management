                    ...
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h6 class="card-subtitle">Subject Details Of Student</h6>
                                <div class="table-responsive table-body">
                                    <!--buttons_start-->
                                    <div class="col-md-12">
                                        <a href="{{url('faculty/subject/create')}}" class="btn btn-info "><i class="fa fa-align-center"></i>&nbsp;&nbsp;Add Subject</a>
                                    ...
                                    <table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                        ...
                                        @foreach($subjects as $subject)
                                            <tr>
                                                <td><input type="checkbox" value="{{$subject->id}}" name="id[]" class="check"/></td>
                                                <td>{{$subject->id}}</td>
                                                <td>{{$subject->semester->sem_name}}</td>
                                                <td>{{$subject->sub_name}}</td>
                                                <td>{{$subject->sub_code}}</td>
                                                <td>
                                                    <a href="{{url('faculty/subject/'.$subject->id.'/edit')}}" class="btn btn-circle btn-lg btn-success icon-size">
                                                         <i class="fa fa-pencil-square-o"></i>
                                                    </a>
                                                    <span>
                                                    <form class="deleteForm" style="display:inline-block;" action="{{url('faculty/subject/'.$subject->id)}}" method="post">
                                                    @csrf
                                                    @method('delete')
...
$(document).on('click','.deleteBtn',function(e){
    ...
    $(document).ready(function(){
        ...
        function action(action){
            ...
            $.ajax({
                type: 'POST',
                data:{ids:subjects.join(','),action:action},
                url: '{{url("faculty/subject/action")}}',
