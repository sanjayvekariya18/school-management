                        ...
                        <div class="card card-body">
                            ...
                            <div class="row">
                                <div class="col-sm-12 col-xs-12">
                                    <form  method="post" action="{{url('faculty/faculty')}}" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <div class="form-group {{($errors->has('image')) ? 'has-danger' : ''}}">
                                        ...
                                        <a href="{{url('faculty/faculty')}}" type="submit" class="btn btn-danger border-danger">Cancel</a>
                                    </form>
                                </div>
                            </div>
                        </div>
