                    ...
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h4 class="card-title">Faculty Detail</h4>
                                <h6 class="card-subtitle">Faculty Details Of Collage</h6>
                                <div class="table-responsive table-body">
                                    <!--buttons_start-->
                                    <div class="col-md-12">
                                        <a href="{{url('faculty/faculty/create')}}" class="btn btn-info "><i class="fa fa-align-center"></i>&nbsp;&nbsp;Add Faculty</a>
                                    ...
                                    <table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                        ...
                                        @foreach($faculties as $faculty)
                                            <tr>
                                                <td><input type="checkbox" value="{{$faculty->id}}" name="id[]" class="check"/></td>
                                                <td>{{$faculty->id}}</td>
                                                <td>
                                                <img src="{{asset('storage/'.$faculty->image)}}" width="100" />
                                                </td>
                                                <td>{{$faculty->stream->stream_name}}</td>
                                                ...
                                                <td>{{($faculty->status) ? "Active" : "Deactive" }}</td>
                                                <td>
                                                    <a href="{{url('faculty/faculty/'.$faculty->id.'/edit')}}" class="btn btn-circle btn-lg btn-success icon-size">
                                                         <i class="fa fa-pencil-square-o"></i>
                                                    </a>
                                                    <span>
                                                    <form class="deleteForm" style="display:inline-block;" action="{{url('faculty/faculty/'.$faculty->id)}}" method="post">
                                                    @csrf
                                                    @method('delete')
...
<script>
    ...
    $(document).ready(function(){
        ...
        function action(action){
            ...
            $.ajax({
                type: 'POST',
                data:{ids:faculties.join(','),action:action},
                url: '{{url("faculty/faculty/action")}}',
