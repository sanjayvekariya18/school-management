                    ...
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <!-- ============================================================== -->
                                <h4 class="card-title">Divison Detail</h4>
                                <h6 class="card-subtitle">Divison Details Of Student</h6>
                                <div class="table-responsive table-body">
                                    <!--buttons_start-->
                                    <div class="col-md-12">
                                        <a href="{{url('faculty/mcq_question/create')}}" class="btn btn-info "><i class="fa fa-align-center"></i>&nbsp;&nbsp;Add Divison</a>
                                    ...
                                    <table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                        ...
                                        @foreach($mcq_questions as $mcq_question)
                                            <tr>
                                                <td><input type="checkbox" value="{{$mcq_question->id}}" name="id[]" class="check"/></td>
                                                <td>{{$mcq_question->id}}</td>
                                                <td>{{$mcq_question->subject->sub_name}}</td>
                                                <td>{{$mcq_question->question}}</td>
                                                <td>{{$mcq_question->op1}}</td>
                                                <td>{{$mcq_question->op2}}</td>
                                                <td>{{$mcq_question->op3}}</td>
                                                <td>{{$mcq_question->op4}}</td>
                                                <td>{{$mcq_question->correct_ans}}</td>
                                                <td>{{$mcq_question->mark}}</td>
                                                <td>{{$mcq_question->negative_mark}}</td>
                                                <td>
                                                    <a href="{{url('faculty/mcq_question/'.$mcq_question->id.'/edit')}}" class="btn btn-circle btn-lg btn-success icon-size">
                                                         <i class="fa fa-pencil-square-o"></i>
                                                    </a>
                                                    <span>
                                                    <form class="deleteForm" style="display:inline-block;" action="{{url('faculty/mcq_question/'.$mcq_question->id)}}" method="post">
                                                    @csrf
                                                    @method('delete')
    ...
    $(document).ready(function(){
        ...
        function action(action){
            ...
            $('#example23 tbody .check:checked').each(function(){
                mcq_questions.push($(this).val());
            });

            $.ajax({
                type: 'POST',
                data:{ids:mcq_questions.join(','),action:action},
                url: '{{url("faculty/mcq_question/action")}}',
