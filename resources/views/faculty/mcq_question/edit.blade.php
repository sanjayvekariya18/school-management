                        ...
                        <div class="card card-body">
                            ...
                            <div class="row">
                                <div class="col-sm-12 col-xs-12">
                                    <form  method="post" action="{{url('faculty/mcq_question/'.$mcq_question->id)}}">
                                    @method('put')
                                    @csrf
                                        ...
                                        <div class="txt_border">
                                            ...
                                            <select class="form-control" name="subject_id" id="subject_id">
                                                ...
                                                @foreach($subjects as $subject)
                                                    @if($subject->id == $mcq_question->subject_id)
                                    ...
                                    <div class="form-group {{($errors->has('question')) ? 'has-danger' : ''}}">
                                        ...
                                        <input type="text" name="question" value="{{$mcq_question->question}}" id="question" class="form-control txt_border" placeholder="Enter Question">
                                        <span class="text-danger">{{$errors->first('question')}}</span>
                                    </div>
                                    <div class="form-group {{($errors->has('op1')) ? 'has-danger' : ''}}">
                                        <label for="op1" >Option 1:</label>
                                        <input type="text" name="op1" id="op1" value="{{$mcq_question->op1}}" class="form-control txt_border" placeholder="Enter Option 1">
                                        <span class="text-danger">{{$errors->first('op1')}}</span>
                                    </div>
                                    <div class="form-group {{($errors->has('op2')) ? 'has-danger' : ''}}">
                                        <label for="op2" >Option 2:</label>
                                        <input type="text" name="op2" id="op2" value="{{$mcq_question->op2}}" class="form-control txt_border" placeholder="Enter Option 2">
                                        <span class="text-danger">{{$errors->first('op2')}}</span>
                                    </div>
                                    <div class="form-group {{($errors->has('op3')) ? 'has-danger' : ''}}">
                                        <label for="op3" >Option 3:</label>
                                        <input type="text" name="op3" id="op3" value="{{$mcq_question->op3}}" class="form-control txt_border" placeholder="Enter Option 3">
                                        <span class="text-danger">{{$errors->first('op3')}}</span>
                                    </div>
                                    <div class="form-group {{($errors->has('op4')) ? 'has-danger' : ''}}">
                                        <label for="op4" >Option 4:</label>
                                        <input type="text" name="op4" id="op4" value="{{$mcq_question->op4}}" class="form-control txt_border" placeholder="Enter Option 4">
                                    ...
                                    <div class="form-group {{($errors->has('correct_ans')) ? 'has-danger' : ''}}">
                                        ...
                                        <input type="text" name="correct_ans" id="correct_ans" value="{{$mcq_question->correct_ans}}" class="form-control txt_border" placeholder="Enter Correct Answer">
                                        <span class="text-danger">{{$errors->first('correct_ans')}}</span>
                                    </div>
                                    <div class="form-group {{($errors->has('mark')) ? 'has-danger' : ''}}">
                                        <label for="mark" >Mark:</label>
                                        <input type="text" name="mark" id="mark" value="{{$mcq_question->mark}}" class="form-control txt_border" placeholder="Enter Mark ">
                                    ...
                                    <div class="form-group {{($errors->has('negative_mark')) ? 'has-danger' : ''}}">
                                        ...
                                        <input type="text" name="negative_mark" id="negative_mark" value="{{$mcq_question->negative_mark}}" class="form-control txt_border" placeholder="Enter Nagative Mark">
                                        <span class="text-danger">{{$errors->first('negative_mark')}}</span>
                                    </div>
                                        <button type="submit" class="btn btn-success waves-effect waves-light m-r-10">Submit</button>
                                        <a href="{{url('faculty/mcq_question')}}" type="submit" class="btn btn-white text-black border-0">Cancel</a>
                                    </form>
                                </div>
                            </div>
                        </div>
