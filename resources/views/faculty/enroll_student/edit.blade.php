                ...
                <div class="row">
                    ...
                    <div class="col-md-8">
                        <div class="card card-body">
                            <h3 class="box-title m-b-0">Enrollment Form</h3>
                            <p class="text-muted m-b-30 font-13"> Form Of Enrollment </p>
                            <div class="row">
                                <div class="col-sm-12 col-xs-12">
                                    <form  method="post" action="{{url('faculty/enroll_student/'.$enroll_student->id)}}" enctype="multipart/form-data">
                                    @method('put')
                                    @csrf
                                    <div class="form-group">
                                        <div class="form-group">
                                            <div class="txt_border">
                                                ...
                                                <select class="form-control" name="student_id" id="name">
                                                    ...
                                                    @if($student->id == $enroll_student->student_id)
                                        ...
                                        <div class="form-group">
                                            <div class="txt_border">
                                                ...
                                                <select class="form-control" name="stream_id" id="name">
                                                    ...
                                                    @if($stream->id == $enroll_student->stream_id)
                                        ...
                                        <div class="form-group">
                                            <div class="txt_border">
                                                ...
                                                <select class="form-control" name="semester_id" id="name">
                                                    ...
                                                    @if($semester->id == $enroll_student->semester_id)
                                        ...
                                        <div class="form-group">
                                            <div class="txt_border">
                                                ...
                                                <select class="form-control" name="divison_id" id="name">
                                                    ...
                                                    @if($divison->id == $enroll_student->divison_id)
                                        ...
                                        <a href="{{url('faculty/enroll_student')}}" type="submit" class="btn btn-danger border-danger">Cancel</a>
                                    </form>
                                </div>
                            </div>
                        </div>
