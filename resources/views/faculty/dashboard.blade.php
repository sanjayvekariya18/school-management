...
<!-- ============================================================== -->
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-3">
                        <img class="img-responsive" alt="user" src="{{asset('assets/dist/images/big/c2.jpg')}}">
                        <div class="card">
                            <div class="card-body">
                    ...
                    <div class="col-md-3">
                        <img class="img-responsive" alt="user" src="{{asset('assets/dist/images/big/c1.jpg')}}">
                        <div class="card">
                            <div class="card-body">
                    ...
                    <div class="col-md-3">
                        <img class="img-responsive" alt="user" src="{{asset('assets/dist/images/big/c4.jpg')}}">
                        <div class="card">
                            <div class="card-body">
                    ...
                    <div class="col-md-3">
                        <img class="img-responsive" alt="user" src="{{asset('assets/dist/images/big/c3.jpg')}}">
                        <div class="card">
                            <div class="card-body">
