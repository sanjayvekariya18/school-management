                    ...
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <!-- ============================================================== -->
                                <h4 class="card-title">Semester Detail</h4>
                                <h6 class="card-subtitle">Semester Details Of Student</h6>
                                <div class="table-responsive table-body">
                                    <!--buttons_start-->
                                    <div class="col-md-12">
                                        <a href="{{url('faculty/semester/create')}}" class="btn btn-info "><i class="fa fa-align-center"></i>&nbsp;&nbsp;Add semester</a>
                                    ...
                                    <table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                        ...
                                        @foreach($semesters as $semester)
                                            <tr>
                                                <td><input type="checkbox" value="{{$semester->id}}" name="id[]" class="check"/></td>
                                                <td>{{$semester->id}}</td>
                                                <td>{{$semester->stream->stream_name}}</td>
                                                <td>{{$semester->sem_name}}</td>
                                                <td>{{($semester->status) ? "Active" : "Deactive" }}</td>
                                                <td>
                                                    <a href="{{url('faculty/semester/'.$semester->id.'/edit')}}" class="btn btn-circle btn-lg btn-success icon-size">
                                                         <i class="fa fa-pencil-square-o"></i>
                                                    </a>
                                                    <span>
                                                    <form class="deleteForm" style="display:inline-block;" action="{{url('faculty/semester/'.$semester->id)}}" method="post">
                                                    @csrf
                                                    @method('delete')
...
<script>
    ...
    $(document).ready(function(){
        ...
        function action(action){
            ...
            $.ajax({
                type: 'POST',
                data:{ids:semesters.join(','),action:action},
                url: '{{url("faculty/semester/action")}}',
