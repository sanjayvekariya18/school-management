                        ...
                        <div class="card card-body">
                            ...
                            <div class="row">
                                <div class="col-sm-12 col-xs-12">
                                    <form  method="post" action="{{url('faculty/schedule/'.$schedule->id)}}">
                                    @method('put')
                                    @csrf
                                    ...
                                    <div class="form-group {{($errors->has('date')) ? 'has-danger' : ''}}">
                                        ...
                                        <input type="date" name="date" value="{{$schedule->date}}" id="date" class="form-control txt_border" placeholder="Enter Date">
                                        <span class="text-danger">{{$errors->first('date')}}</span>
                                    </div>
                                    <div class="form-group {{($errors->has('start_time')) ? 'has-danger' : ''}}">
                                        <label for="start_time" >Start Time:</label>
                                        <input type="time" name="start_time" id="start_time" value="{{$schedule->start_time}}"  class="form-control txt_border" placeholder="Fill Start Time">
                                        <span class="text-danger">{{$errors->first('start_time')}}</span>
                                    </div>
                                    <div class="form-group {{($errors->has('end_time')) ? 'has-danger' : ''}}">
                                        <label for="end_time" >End Time:</label>
                                        <input type="time" name="end_time" id="end_time" value="{{$schedule->end_time}}"  class="form-control txt_border" placeholder="Fill End Time">
                                    ...
                                    <div class="form-group {{($errors->has('top_scorer')) ? 'has-danger' : ''}}">
                                                    ...
                                                    <div class="txt_border">
                                                        <select class="form-control" name="top_scorer" > 
                                                            <option value="">SELECT</option>
                                                            <option value="Yes" {{($schedule->top_scorer == "Yes") ? "selected" : "" }}>Yes</option>
                                                            <option value="No" {{($schedule->top_scorer == "No") ? "selected" : "" }}>No</option>
                                                        </select>
                                                    </div>
                                    ...
                                    <div class="form-group {{($errors->has('no_of_top_scorers')) ? 'has-danger' : ''}}">
                                        ...
                                        <input type="text" name="no_of_top_scorers" id="no_of_top_scorers" value="{{$schedule->no_of_top_scorers}}"  class="form-control txt_border" placeholder="Enter Number Of Top Scorers">
                                        <span class="text-danger">{{$errors->first('no_of_top_scorers')}}</span>
                                    </div>
                                        <button type="submit" class="btn btn-success waves-effect waves-light m-r-10">Submit</button>
                                        <a href="{{url('faculty/schedule')}}" type="submit" class="btn btn-white text-black border-0">Cancel</a>
                                    </form>
                                </div>
                            </div>
                        </div>
