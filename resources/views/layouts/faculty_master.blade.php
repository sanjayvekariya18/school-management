...
<!-- Mirrored from eliteadmin.themedesigner.in/demos/bt4/university/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 06 Aug 2018 03:37:14 GMT -->
<head>
    <meta charset="utf-8">
                ...
                <div class="navbar-header">
                    <a class="navbar-brand" href="index.html">
                        <!-- Logo icon --><b>
                            ...
                            <!-- Dark Logo icon -->
                            <img src="{{asset('assets/images/bmbcalogo.png')}}" alt="homepage" style="width:40;height:40;" class="dark-logo" />
                            <!-- Light Logo icon -->
                            <img src="{{asset('assets/images/bmbcalogo.png')}}" alt="homepage" style="width:40;height:40;" class="light-logo" />
                        </b>
                        <!--End Logo icon -->
                        <span class="hidden-xs">BM<span class="font-bold">BCA</span></span>
                    </a>
                </div>
                <!-- ============================================================== -->
                <!-- End Logo -->
        ...
        <aside class="left-sidebar">
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        <li class="user-pro"> <a class="has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><img src="{{asset('assets/images/users/1.jpg')}}" alt="user-img" class="img-circle"><span class="hide-menu">Prof. Mark</span></a>
                        ...
                        <li> <a class="has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="fa fa-align-center"></i><span class="hide-menu">Stream</span></a>
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="{{url('faculty/stream/create')}}">Add Stream</a></li>
                                <li><a href="{{url('faculty/stream')}}">View Stream</a></li>
                            </ul>
                        </li>
                        <li> <a class="has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="fa fa-plus"></i><span class="hide-menu">Semester</span></a>
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="{{url('faculty/semester/create')}}">Add Semester</a></li>
                                <li><a href="{{url('faculty/semester')}}">View Semester</a></li>
                            </ul>
                        </li>
                        <li> <a class="has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="fa fa-book"></i><span class="hide-menu">Subject</span></a>
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="{{url('faculty/subject/create')}}">Add Subject</a></li>
                                <li><a href="{{url('faculty/subject')}}">View Subject</a></li>
                            </ul>
                        </li>
                        <li> <a class="has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="fa fa-users"></i><span class="hide-menu">Divison</span></a>
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="{{url('faculty/divison/create')}}">Add Divison</a></li>
                                <li><a href="{{url('faculty/divison')}}">View Divison</a></li>
                            </ul>
                        </li>
                        <li> <a class="has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="fa fa-user-plus"></i><span class="hide-menu">Professor Subject</span></a>
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="{{url('faculty/faculty_subject/create')}}">Add Professor Subject</a></li>
                                <li><a href="{{url('faculty/faculty_subject')}}">View Professor Subject</a></li>
                            </ul>
                        </li>
                        <li> <a class="has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="icon-people fa fa-user"></i><span class="hide-menu">Professors</span></a>
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="{{url('faculty/faculty/create')}}">Add Professors</a></li>
                                <li><a href="{{url('faculty/faculty')}}">View Professor</a></li>
                        ...
                        <li> <a class="has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="fa fa-graduation-cap"></i><span class="hide-menu">Students</span></a>
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="{{url('faculty/student/create')}}">Add Students</a></li>
                                <li><a href="{{url('faculty/student')}}">View Student</a></li>
...
<!-- Mirrored from eliteadmin.themedesigner.in/demos/bt4/university/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 06 Aug 2018 03:39:33 GMT -->
</html>